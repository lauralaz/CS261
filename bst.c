/*Laura Lazenby
  2/10/16
  Solution Description: This program implements a binary tree and provides test output.*/
/*
 File: bst.c
...
struct Node *_addNode(struct Node *cur, TYPE val)
{
	...
	int compared = compare(cur->val, val);
	...
	return cur;
	//written by teacher the return null part return NULL;
}
...
TYPE _leftMost(struct Node *cur)
{
	...
	return cur->val;
	//this was given by the zip file return NULL;
}
...
struct Node *_removeLeftMost(struct Node *cur)
{
	...
	return cur;
	//return NULL this is what was given in zip file;
}
/*
